...
import Header, { DemmyHeader } from "../SuperAdmin/Header";
...
function AdminAsset() {
  const assetOption = [{ option: "Select Asset" }, { option: "All Assets" }, { option: "Updated Assets" }];
  ...
  return (
    <div className=" InterRegularFamily Chat">
      <div className="font-size-9em InterBoldFamily">{"Assets"}</div>
      <Breadcrumb
        breadcrumbs={[
          {
            menu: "Asset",
