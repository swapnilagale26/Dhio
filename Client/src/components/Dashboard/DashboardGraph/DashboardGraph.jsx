...
import LineDetailGraph from "./LineDetailGraph";
    ...
    dashBoardData && (
      <div>
        ...
        <div className="SecondCombinedChart">
          <LineGraph data={dashBoardData.Line} />

          {/* third Bar Chart */}
          <BarGraph data={dashBoardData.Bar} />
        </div>
        {/* first line Chart */}
        <div className="firstchart">
          <LineDetailGraph data={dashBoardData.LineYear} />
        </div>
      </div>
    )
  );
